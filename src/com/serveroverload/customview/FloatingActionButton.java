...
public class FloatingActionButton extends ImageButton {
	...
	private void init(Context context, AttributeSet attributeSet) {
		mVisible = true;
		mColorNormal = getColor(R.color.clouds);
	...
	private Drawable createDrawable(int color) {
		...
		if (mShadow && !hasLollipopApi()) {
			Drawable shadowDrawable = getResources()
					.getDrawable(mType == TYPE_NORMAL ? R.drawable.fab_shadow : R.drawable.fab_shadow_mini);
	...
	// }
	//
	// public void setOnScrollListener(RecyclerView.OnScrollListener
	// onScrollListener) {
	// mOnScrollListener = onScrollListener;
	// }
	//
