...
import com.serveroverload.ui.activity.SampleActivity;
...

{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.row_swipe_grid_item,
					parent, false);
			...
			holder.rootbackGround = (ImageView) convertView
					.findViewById(R.id.top_view_back);
		...
		//
		// holder.categoryName.setText(listOfProductsCategory.get(position)
		// .getProductCategoryName());
		//
		// holder.categoryDescription.setText(listOfProductsCategory.get(position)
		...
		Picasso.with(context)
				.load((new File(listOfProductsCategory.get(position)))).fit()
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				UtilFunctions.switchFragmentWithAnimation(R.id.frag_root,
						...
						(SampleActivity) getContext(), "FullScreenPagerFragment",
